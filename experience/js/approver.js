...
import { mountScreen, getScreenElement, unmountScreen, applySurfaceMask } from './screens.js?v=2026-09-10s';
import { panRoom } from './stage.js?v=2026-09-10s';
import clock from './clock.js?v=2026-09-10s';
